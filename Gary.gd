...
func _physics_process(delta):
	...
	if global.level_color == 0:
		...
		$Head/Camera/Blue.visible = false
	elif global.level_color == 1:
		$Head/Camera/Red.visible = true
		$Head/Camera/Green.visible = false
		$Head/Camera/Blue.visible = false
	elif global.level_color == 2:
		$Head/Camera/Red.visible = false
		$Head/Camera/Green.visible = true
		$Head/Camera/Blue.visible = false
	elif global.level_color == 3:
		$Head/Camera/Red.visible = false
		$Head/Camera/Green.visible = false
		$Head/Camera/Blue.visible = true
	else:
		global.level_color = 0
		
	if Input.is_action_just_pressed("change_color"):
		global.level_color += 1
